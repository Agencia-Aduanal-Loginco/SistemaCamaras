...
You have a persistent Persistent Agent Memory directory at `/home/tony/Developer/ChecadorLogincoV2/.claude/agent-memory/django-architect/`. Its contents persist across conversations.
...
1. Search topic files in your memory directory:
```
Grep with pattern="<search term>" path="/home/tony/Developer/ChecadorLogincoV2/.claude/agent-memory/django-architect/" glob="*.md"
```
2. Session transcript logs (last resort — large files, slow):
```
